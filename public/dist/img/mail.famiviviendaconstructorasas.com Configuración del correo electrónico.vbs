' mail.famiviviendaconstructorasas.com Configuración del correo electrónico.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "mail.famiviviendaconstructorasas.com"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.famiviviendaconstructorasas.com"		 					' This is the address for the mail server
...
strAccount			   = "info@famiviviendaconstructorasas.com"							' Mail account to connect as
strSecureConnection    = "00000000"					' Use a secure connection - 00000001 for true, 00000000 for false
strCloseText 		   = "Cierre Windows Live Mail antes de continuar."
strFolderNotFoundText  = "Windows Live Mail no debe estar instalado; no se encontró el siguiente directorio:"
strProgramNotFoundText = "Windows Live Mail no debe estar instalado; no se encontró el siguiente archivo:"
strFileNotFoundText	   = "No se encontró el archivo."
