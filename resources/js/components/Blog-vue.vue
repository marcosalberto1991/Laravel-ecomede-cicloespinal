  ...
  <div class='card-body'><h1 class=''>Lista de Blog </h1>
    ...
    <div class='col-12'>
      ...
      <template v-slot:cell(Acciones)='data'>
          ...
          <b-button-group>
          <!--
          <b-button v-if="$can('Blog Editar')" size='sm' variant='warning'  type='button' class='btn-sm btn btn-wangir mr-1' data-toggle='button' aria-pressed='false' style='margin-bottom: 5px; margin: 5px;'>Editar
            </b-button>
            -->
            <router-link v-if="$can('Blog Editar')" :to="{ name: 'blogform', params: { id: data.item.id }}">
