...
<div class="row">
    <div class="col-lg-12 ">
      ...
      <form ref="form"   v-on:submit.prevent="formulario()">
        <div class="row">
          <div class="col-md-12 row">
            <input type="hidden" v-model="input_Carrito_Compra_id">
            ...
            <div class="form-group col-md-4 col-sm-12">
                ...
                <input type="text" v-model="input_cantidad" placeholder="cantidad" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
...
export default {
  ...
  data() {
    ...
    return {
      ...
      data_foraneo_producto_id:[],data_foraneo_users_id:[],
      input_id:[],
      input_producto_id:[],
      input_precio_comprado:[],
      input_cantidad:[],
      input_users_id:[],
  ...
  methods: {
    ...
    anadir_registro(){
      this.validacion="";
      this.formulario_Carrito_Compra=true;
    ...
    formulario(){
      ...
      const data = {
        id: this.input_Carrito_Compra_id,
        id :this.input_id,
        producto_id :this.input_producto_id,
        precio_comprado :this.input_precio_comprado,
      ...
      if(this.editar_dato == true){
        axios.put(`/Carrito_Compra/${this.input_Carrito_Compra_id}`, data)
        .then(response => {
            ...
            if(response.data.id){
              ...
              this.formulario_Carrito_Compra=false;
              window.history.back();
        ...
        axios.post(`/Carrito_Compra`, data).then(response => {
            const datos = response.data;
            if(response.data.errors){
              this.$toastr.warning("Verifique los datos", "Verifique los datos");
              this.validacion=response.data.errors;
    ...
    show_registro(data_id){//show_registro
      ...
      axios.get(`/Carrito_Compra/${data_id}`).then(response => {
            ...
            if(!response.data){
              ...
              this.input_Carrito_Compra_id = data.id
              this.input_id = data.id;
              this.input_producto_id = data.producto_id;
              this.input_precio_comprado = data.precio_comprado;
