  ...
  <div class='card-body'><h1 class=''>Lista de Producto_Venta </h1>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      data_foraneo_producto_id:[],data_foraneo_venta_id:[],
  ...
  methods: {
    ...
    consulta(page = 1){
      if (localStorage.getItem("Producto_Venta")) {
        try { this.items = JSON.parse(localStorage.getItem("Producto_Venta"));
        } catch (e) { localStorage.removeItem("Producto_Venta");}
      }
