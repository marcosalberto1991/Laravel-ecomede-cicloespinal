<?php
	...
	class Carrito_CompraModel extends Model implements Auditable {
    ...
    public function producto_imagen_pk(){
      return $this->belongsTo('App\ProductoImagenModel', 'producto_imagen');
    }
